   ...
   <div class="temperaturecontainer">
             ...
             if ($weather["solardmax"] >= 1000) {
                 echo "<div class='uvtoday9-10'>",
                     $weather["solardmax"] . "</value>";
             } elseif ($weather["solardmax"] >= 500) {
                 echo "<div class='uvtoday6-8'>",
                     $weather["solardmax"] . "</value>";
             } elseif ($weather["solardmax"] >= 300) {
                 echo "<div class='uvtoday4-5'>",
                     $weather["solardmax"] . "</value>";
             } elseif ($weather["solardmax"] >= -0) {
...
<div class="higust">Maximum Recorded <br><blue><?php echo $weather[
    "solardmaxtime"
]; ?></blue></div>
  ...
  <div class=actualt>Yesterday </div>        
   <div class="temperaturecontainer">
             ...
             if ($weather["solarydmax"] >= 1000) {
                 echo "<div class='uvtoday9-10'>",
                     $weather["solarydmax"] . "</value>";
             } elseif ($weather["solarydmax"] >= 500) {
                 echo "<div class='uvtoday6-8'>",
                     $weather["solarydmax"] . "</value>";
             } elseif ($weather["solarydmax"] >= 300) {
                 echo "<div class='uvtoday4-5'>",
                     $weather["solarymax"] . "</value>";
             } elseif ($weather["solarydmax"] >= -0) {
                 echo "<div class='uvtoday1'>",
                     $weather["solarydmax"] . "</value>";
             }
             echo "<smalluvunit> W/m<sup>2</sup></smalluvunit>";
  ...
  <div class=actualt><?php echo date("F Y"); ?> </div>        
   <div class="temperaturecontainer">
             ...
             if ($weather["solarmmax"] >= 1000) {
                 echo "<div class='uvtoday9-10'>",
                     $weather["solarmmax"] . "</value>";
             } elseif ($weather["solarmmax"] >= 500) {
                 echo "<div class='uvtoday6-8'>",
                     $weather["solarmmax"] . "</value>";
             } elseif ($weather["solarmmax"] >= 300) {
                 echo "<div class='uvtoday4-5'>",
                     $weather["solarmmax"] . "</value>";
             } elseif ($weather["solarmmax"] >= -0) {
                 echo "<div class='uvtoday1'>",
                     $weather["solarmmax"] . "</value>";
             }
             echo "<smalluvunit> W/m<sup>2</sup></smalluvunit>";
  ...
  <div class=actualt><?php echo date("Y"); ?> </div>        
   <div class="temperaturecontainer">
             ...
             if ($weather["solarymax"] >= 1000) {
                 echo "<div class='uvtoday9-10'>",
                     $weather["solarymax"] . "</value>";
             } elseif ($weather["solarymax"] >= 500) {
                 echo "<div class='uvtoday6-8'>",
                     $weather["solarymax"] . "</value>";
             } elseif ($weather["solarydmax"] >= 300) {
                 echo "<div class='uvtoday4-5'>",
                     $weather["solarYmax"] . "</value>";
             } elseif ($weather["solarymax"] >= -0) {
                 echo "<div class='uvtoday1'>",
                     $weather["solarymax"] . "</value>";
             }
             echo "<smalluvunit> W/m<sup>2</sup></smalluvunit>";
  ...
  <div class=actualt>All-Time</div>        
   <div class="temperaturecontainer">
             ...
             if ($weather["solaramax"] >= 1000) {
                 echo "<div class='uvtoday9-10'>",
                     $weather["solaramax"] . "</value>";
             } elseif ($weather["solaramax"] >= 500) {
                 echo "<div class='uvtoday6-8'>",
                     $weather["solaramax"] . "</value>";
             } elseif ($weather["solaradmax"] >= 300) {
                 echo "<div class='uvtoday4-5'>",
                     $weather["solaramax"] . "</value>";
             } elseif ($weather["solaramax"] >= -0) {
                 echo "<div class='uvtoday1'>",
                     $weather["solaramax"] . "</value>";
             }
             echo "<smalluvunit> W/m<sup>2</sup></smalluvunit>";
...
<div class="higust">Maximum Recorded <br><blue><?php echo $weather[
 ...
 <main class="grid1">
  ...
  <articlegraph> 
     <iframe  src="w34highcharts/<?php echo $theme1; ?>-charts.html?chart='radsmallplot'&span='yearly'&temp='<?php echo $weather[
    "temp_units"

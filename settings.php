...
$wucredits          = "Data provided by The Weather Company"; // for chart pages only
$creditschart 		= "CanvasJs.com v2.3.1 GA (CC BY-NC 3.0) Non-Commercial-Version";
$creditsURL         = ""; // for chart pages only
$credits            = "Data Supplied via The Weather Company"; // for chart pages only
...
if (array_key_exists('units', $_GET) && ($_GET['units'] == 'default' || $_GET['units'] == '')) {
  ...
  $units = '';
} else if (array_key_exists('units', $_GET) && ($_GET['units'] == 'us' || $_GET['units'] == 'ca' || $_GET['units'] == 'uk' || $_GET['units'] == 'metric' || $_GET['units'] == 'scandinavia')) {

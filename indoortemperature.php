...
<div class="mod-temperature-indoor-graphic">
<div class="indoortrendhouse1">Indoor</div>  
...
<?php //temperture indoor celsius
 if (anyToC($weather["temp_indoor"]) >30){echo "<div class=\"mod-indoor-temp--hot\">",$weather["temp_indoor"]  ;echo "&deg;<smalluvunit>".$weather["temp_units"]."</div>" ; } else if (anyToC($weather["temp_indoor"]) >24){echo "<div class=\"mod-indoor-temp--warm\">",$weather["temp_indoor"]  ;echo "&deg;<smalluvunit>".$weather["temp_units"]."</div>" ; } else if (anyToC($weather["temp_indoor"]) >20){echo "<div class=\"mod-indoor-temp--mild\">",$weather["temp_indoor"]  ;echo "&deg;<smalluvunit>".$weather["temp_units"]."</div>" ; }
 else if (anyToC($weather["temp_indoor"]) >15){ echo "<div class=\"mod-indoor-temp--cool\">", $weather["temp_indoor"]  ;echo "&deg;<smalluvunit>".$weather["temp_units"]."</div>" ; } else { echo "<div class=\"mod-indoor-temp--cold\">", $weather["temp_indoor"]  ;echo "&deg;<smalluvunit>".$weather["temp_units"]."</div>" ; }?></div>

...
function downloadfromgit($filename)
{
    if (!is_readable($filename) || filesize($filename) < 100)
    {
        ...
        $options = array(
            ...
            CURLOPT_TIMEOUT => 10,
            CURLOPT_URL => 'https://github.com/meisnick/weewx-Weather34/blob/master/www/settings1.default.php'
        );
        $ch = curl_init();
        ...
        {
            echo ($filename . " did not download properly, please visit <a href='https://raw.githubusercontent.com/meisnick/weewx-Weather34/master/www/settings1.default.php?token=AEMVT7U4QB6O67Z35VADMUK6QGMRM' target='_blank'>https://raw.githubusercontent.com/meisnick/weewx-Weather34/master/www/settings1.default.php?token=AEMVT7U4QB6O67Z35VADMUK6QGMRM</a>, right click anywhere on the page and choose to save the file. Then copy the file into the root of your website (where you downloaded the website files to on your server).<br/>");
            die();
        }
    }
}

...
// NOTE: index2.php = fully modular build. No main.dark.css / main.light.css here —
// cards get ALL their styling from css/modules/*.css inside the framework shell.
...
document.body.classList.toggle('cols-2', String(currentCols) === '2');
document.body.classList.toggle('cols-3', String(currentCols) === '3');
...
function setColumns(cols) {
    currentCols = cols;
    document.body.classList.toggle('cols-2', String(cols) === '2');

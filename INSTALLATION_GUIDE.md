...
IMPORTANT. If you are making a completely clean install of WeeWX and Weather34 Template it is strongly recommended that you allow the WeeWX database to establish itself for 24 hours before attempting installing the template.
...
* Please familiarise yourself with the location of your WeeWX system files including your bin/user folder, skins folder and weewx.conf file. If you are unsure where to find these, please refer to the installation processes here: - http://www.weewx.com/docs/setup.htm which shows various WeeWX installation scenarios.

IMPORTANT. Installing PHP; please make sure you install all the PHP modules appropriate for your version of PHP. Failure to do so may mean that forecasts and current conditions fail to update. This is an example for PHP8.1 modules on a Debian based distribution: -
...
* Using a RAM Disk for w34realtime.txt. The default location is hard-coded but can be changed: -
	...
	Edit the [Weather34RealTime] stanza in weewx.conf
        ...
        Edit line 28 in weather34/settings1.php (or your settings file)
...
* Automatic database backup module. 
   ...
   Then at the end of the file add this stanza: -
			...
			[W34_DB_Backup]
				...
				# database path(s) separated by , rename this/these database(s) to match your own
    				databases = /home/weewx/archive/weewx.sdb,/home/weewx/archive/another.sdb
				
				# backup path(s) comma separated 
...
* There is a further guide of how to install weewx_Weather34 on a remote server here: - https://github.com/meisnick/weewx-Weather34/blob/main/REMOTE_SERVER.md and an excellent online guide by User Chris Alemany at https://www.chrisalemany.ca/2021/02/24/installing-the-weather34-skin-on-weewx-with-remote-web-server-2021-edition/

...
Meteogram.prototype.getChartOptions = function () {
    ...
    return {
        ...
        xAxis: [{ // Bottom X axis
            ...
            tickLength: 0,
            gridLineWidth: 1,
            gridLineColor: (Highcharts.theme && Highcharts.theme.background2) || '#C0C0C0',
            startOnTick: false,
            endOnTick: false,
            minPadding: 0,
            maxPadding: 0,
...
if (!location.hash) {
	...
	//location.hash = 'https://www.yr.no/place/United_States/Wisconsin/Your_City/forecast_hour_by_hour.xml';
...
$.ajax({
    dataType: 'json',
    url: '<?php echo "$meteogramURL"; ?>/weewx/weather34/w34highcharts/jsonp.php?url=' + location.hash.substr(1) + '&callback=?',
	...
	<body>
      ...
      <script src="scripts/light-theme.js" type="text/javascript"></script>
